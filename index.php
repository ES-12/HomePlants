    ...
    <header>
        ...
        <div class="container">
            <div class="description">
                ...
                <button class="btn btn-outline-dark">Подобрать растения</button>
            </div>
        </div>
    </header>
        ...
        <div class="catalog">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-10">
                    <div class="card">
                        <img src="./images/chris-lee-70l1tDAI6rM-unsplash 1.png" class="card-img-top" alt="...">
                        <div class="card-body">
                            <div class="card-desc d-flex justify-content-between">
                                <p class="card-title">Монстера</p>
